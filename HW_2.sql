...
modify employeeid int auto_increment;

alter table employees
change lastname last_name varchar(128);
...
-- 1. Найти всех ИТ работников с зарплатой выше 12000
select * from employees
where salary > 12000;

-- 2. Повысить зарплату работников отдела Human Resources в 5 раз
update employees
set salary = (salary * 5)
where department like 'Human Resources';

-- 3. Найти работников отдела Marketing с зарплатой ниже 2850.
select * from employees
where salary<2850 and department = 'Marketing';

-- 4. У руководителя родились близнецы Лаура и Адам, в честь праздника он решил повысить 
-- зарплату работников с именами Лаура и Адам в 10 раз. 'Laura' 'Adam'
update employees
set salary = (salary * 10)
where first_name like 'Laura' or first_name like 'Adam';

-- 5. Diana Lorentz вышла замуж и поменяла фамилию на King. 
-- Поменяйте у Diana Lorentz фамилию на King.
update employees
set last_name = 'King'
where first_name = 'Diana' and last_name ='Lorentz';

-- 6. Всех работников отдела sales уволили. Удалите работников sales из таблицы.
delete from employees
where department = 'sales';

-- 7. John Russell перевели в отдел Marketing и повысили зарплату на 5000. 
...
-- 8. После праздника руководитель протрезвел и уменьшил зарплаты работников 
-- с именами Лаура и Адам в 10 раз.
update employees
set salary = (salary / 10)
where first_name like 'Laura' or first_name like 'Adam';

-- 9. Laura Bissot поменяла свой мейл на BISSOTLAURA. 
-- Измените данные для работника Laura Bissot.
update employees
set email = 'BISSOTLAURA'
where first_name = 'Laura' and last_name ='Bissot';

-- 10. Diana King развелась и поменяла фамилию обратно на Lorentz. 
-- И в честь развода руководитель повысил ее зарплату на 2000. 
