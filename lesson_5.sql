...
-- Поменять статус заказа на 1 для тех покупателей, 
-- у которых сумма заказа больше 1200 и статус заказа 0.
update customers
set delivery_status = 1
where sum_price > 1200 and delivery_status = 0;

-- Удалить записи тех покупателей, у которых имя начинается на букву L, 
-- а фамилия заканчивается на O.
delete from customers
